...
public class ONAKPSPublicSoap
{
    ...
    public ONAKPSPublicSoap(){}

    public ONAKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public ONAKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        ONAExtendedSoapSerializationEnvelope envelope= new ONAExtendedSoapSerializationEnvelope(ONAExtendedSoapSerializationEnvelope.VER11);
