...
public class ONAExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(ONADateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new ONAStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static ONADateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static ONADateTimeConverter dateTimeConverter = new ONAStandardDateTimeConverter();

    public ONAExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public ONAExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new ONAMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=ONAHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,ONAExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=ONAHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
